...
- [ ] 시나리오별 샘플 입력 데이터 작성
  - [ ] SD-01. 시나리오 A (뉴스 기억 복원) 샘플 입력 5건
  - [ ] SD-02. 시나리오 B (영화/콘텐츠 기억 복원) 샘플 입력 5건
  - [ ] SD-03. 시나리오 C (만델라 효과/잘못된 상식 보정) 샘플 입력 5건
- [ ] 시나리오별 샘플 보정 결과 데이터 작성
  - [ ] SD-04. 각 샘플 입력에 대한 보정 결과 (확정 사실 + 추측 + 출처) 작성 (총 15건)
  - [ ] SD-05. 이력 목록 화면(SCR-06) 기본 표시용 샘플 이력 데이터 15건 포함하여 `.ai/assets/sample_data.json` 으로 저장
